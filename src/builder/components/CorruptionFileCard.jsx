...
const CorruptionFileCard = forwardRef(function CorruptionFileCard(
  ...
  return (
    ...
    >
      ...
      {showIncidentNumber && <div className="corruption-file-index" aria-hidden="true">{incidentNumber}</div>}
      ...
      <div className="corruption-file-content">
        <header className="corruption-file-head">
          <div>
            ...
            <strong>INCIDENT FILE{showIncidentNumber ? ` / ${incidentNumber}` : ''}</strong>
          </div>
